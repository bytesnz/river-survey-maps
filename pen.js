...
/***/ function(module, exports) {
	...
	var halflifeLengths = [['1 hour', 3600000], ['1 day', 86400000], ['1 week', 604800000], ['1 month', 2592000000], ['1 year', 31536000000]];
	...
	var reloadData = survey => {
	  ...
	  if (typeof survey !== 'string' && typeof surveys[survey] !== 'undefined' && !toFetch.length) {
	    redrawSurveyData(survey);
	  }
	};
	...
	map.createPane('controls', controlsLayer);
